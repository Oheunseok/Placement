...
def draw_point(x1: object, y1: object):
...
class Image:
    ...
    def rotate_draw(self, rad, x, y, w = None, h = None):
        ...
        SDL_SetTextureColorMod(self.texture, ctypes.c_uint8(self.r), ctypes.c_uint8(self.g), ctypes.c_uint8(self.b))
    ...
    def composite_draw(self, rad, flip, x, y, w = None, h = None):
        ...
        SDL_RenderCopyEx(renderer, self.texture, None, rect, m_mathclass.degrees(-rad), None, flip_flag)
    ...
    def clip_composite_draw(self, left, bottom, width, height, rad, flip, x, y, w = None, h = None):
        ...
        if 'v' in flip:
            flip_flag |= SDL_FLIP_VERTICAL
        SDL_RenderCopyEx(renderer, self.texture, src_rect, dst_rect, m_mathclass.degrees(-rad), None, flip_flag)
...
def create_image_surface(name,width,height):

    r = c_uint32(0xff000000)
    g = c_uint32(0x00ff0000)
    b = c_uint32(0x0000ff00)
    a = c_uint32(0x000000ff)


    surface = SDL_CreateRGBSurfaceFrom(name,width,height,32,4*width,r,g,b,a)
